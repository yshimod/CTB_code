...
foreach i of local levels {
    ...
    local DENOM1      = " pratio                                      ^ ( rho / ( rho - 1 ) ) "
    local DENOM2prsnt = " ( {beta=`TMPbeta'} * {delta=`TMPdelta'}^k ) ^ ( 1.0        / ( rho - 1 ) ) "
    local DENOM2      = " (                    {delta=`TMPdelta'}^k ) ^ ( 1.0        / ( rho - 1 ) ) "

    local NUMERprsnt = " ( {beta=`TMPbeta'} * {delta=`TMPdelta'}^k * pratio ) ^ ( 1.0 / ( rho - 1 ) ) "
    local NUMER      = " (                    {delta=`TMPdelta'}^k * pratio ) ^ ( 1.0 / ( rho - 1 ) ) "
...
save "base_estimated_M3.dta", replace
